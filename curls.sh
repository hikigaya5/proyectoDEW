...
curl -s --data '{"apellidos":"Fernández", "dni":"222222222H", "nombre":"Maria", "password":"123456"}' -X POST -H "content-type: application/json" "http://dew-cgarmon1-2324.dsicv.upv.es:9090/CentroEducativo/alumnos?key=$KEY" -c cucu -b cucu
